...
def receive_and_modify():
    """Receive & Modify Packet - FIXED VERSION"""
        ...
        try:
            ...
            try:
                ...
                try:
                    ...
                    # ALWAYS log the original packet first
                    log_packet_details(
                        packet_data=original_payload, 
                        is_original=True,  # This is the ORIGINAL packet
                    ...
                    if modified_payload != original_payload:
                        ...
                        log_packet_details(
                            ...
                            is_original=False,  # This is the MODIFIED packet
                            src_ip=headers["src_ip"],
                            dst_ip=headers["dst_ip"],
                            src_port=headers["src_port"],
                            dst_port=headers["dst_port"],
